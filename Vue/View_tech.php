...
<?php
    ...
    <section class="content-section">
        ...
        if ($page == 'donnes') {
            ...
            echo '<h2>Demandes Affecté</h2><iframe src="View_DemandAFT.php" frameborder="0" class="content-iframe"></iframe>';
        } elseif ($page === 'demand') {
            echo '<h2>Demandes</h2><iframe src="View_DemandRepT.php" frameborder="0" class="content-iframe"></iframe>';
        } elseif ($page === 'inter') {
            echo '<h2>Intervention</h2><iframe src="View_interADDT.php" frameborder="0" class="content-iframe"></iframe>';
        }elseif ($page === 'quit') {
            session_destroy();
